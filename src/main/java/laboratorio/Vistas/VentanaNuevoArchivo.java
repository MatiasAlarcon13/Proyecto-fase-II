...
public class VentanaNuevoArchivo extends JDialog {
    ...
    public VentanaNuevoArchivo() {
        ...
        btnSolicitar.addActionListener(e -> {
            ...
            VentanaConfirmacion.VentanaConfirmacion ventanaExito = new VentanaConfirmacion.VentanaConfirmacion();
    ...
    public static class VentanaNuevoArchivo extends JDialog {
        private JPanel PanelNuevoArchivo;
        private JButton btnSolicitar;
        private JButton buttonCancel;
        private JTextField titularSolicitud;
        ...
        public VentanaNuevoArchivo() {
            ...
            btnSolicitar.addActionListener(e -> {
                ...
                // 2. Creamos el SEGUNDO JDialog (el de éxito o carga completa)
                JDialog dialogoExito = new JDialog(ventanaPadre, "Solicitud Exitosa", ModalityType.APPLICATION_MODAL);
        ...
        public static void main(String[] args) {
            laboratorio.Vistas.VentanaNuevoArchivo dialog = new laboratorio.Vistas.VentanaNuevoArchivo();
            dialog.pack();
            dialog.setVisible(true);
            System.exit(0);
        }
