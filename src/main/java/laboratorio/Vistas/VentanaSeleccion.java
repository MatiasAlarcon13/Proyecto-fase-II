...
public class VentanaSeleccion {
    ...
    private void abrirPantallaLogin(String rolSeleccionado) {
        ...
        if (frameActual != null) {
            PantallaLogin.PantallaLogin pantallaLogin = new PantallaLogin.PantallaLogin(rolSeleccionado);
    ...
    private void abrirPantallaAdd() {
        ...
        if (frameActual != null) {
            PantallaAddUser.PantallaAddUser pantallaAddUser = new PantallaAddUser.PantallaAddUser();
    ...
    public static class VentanaSeleccion {
        private JLabel NombrePrograma;
        private JLabel Subtitulo;
        private JButton profesorButton;
        private JButton alumnoInvitadoButton;
